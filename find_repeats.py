...
if __name__ == '__main__':
    ...
    chromosomes_list = ['Homo_sapiens.GRCh38.dna.chromosome.1.fa',
                        ...
                        'Homo_sapiens.GRCh38.dna.chromosome.7.fa',
                        'Homo_sapiens.GRCh38.dna.chromosome.8.fa',
                        ...
                        'Homo_sapiens.GRCh38.dna.chromosome.16.fa',
                        'Homo_sapiens.GRCh38.dna.chromosome.17.fa',
                        'Homo_sapiens.GRCh38.dna.chromosome.18.fa',
