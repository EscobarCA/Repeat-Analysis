...
gene_files = ['NC_000001.11_genes.json', 'NC_000002.12_genes.json',
              'NC_000003.12_genes.json', 'NC_000004.12_genes.json',
              'NC_000005.10_genes.json', 'NC_000006.12_genes.json',
              'NC_000007.14_genes.json', 'NC_000008.11_genes.json',
              'NC_000009.12_genes.json', 'NC_000010.11_genes.json',
              'NC_000011.10_genes.json', 'NC_000012.12_genes.json',
              'NC_000013.11_genes.json', 'NC_000014.9_genes.json',
              'NC_000015.10_genes.json', 'NC_000016.10_genes.json',
              'NC_000017.11_genes.json', 'NC_000018.10_genes.json',
              'NC_000019.10_genes.json', 'NC_000020.11_genes.json',
              'NC_000021.9_genes.json', 'NC_000022.11_genes.json',
              'NC_000023.11_genes.json', 'NC_000024.10_genes.json']

# List of files with repeats found in sense strand
pos_files = ['Repeats_1_+.txt', 'Repeats_2_+.txt', 'Repeats_3_+.txt',
             'Repeats_4_+.txt', 'Repeats_5_+.txt', 'Repeats_6_+.txt',
             'Repeats_7_+.txt', 'Repeats_8_+.txt', 'Repeats_9_+.txt',
             'Repeats_10_+.txt', 'Repeats_11_+.txt', 'Repeats_12_+.txt',
             'Repeats_13_+.txt', 'Repeats_14_+.txt', 'Repeats_15_+.txt',
             'Repeats_16_+.txt', 'Repeats_17_+.txt', 'Repeats_18_+.txt',
             'Repeats_19_+.txt', 'Repeats_20_+.txt', 'Repeats_21_+.txt',
             'Repeats_22_+.txt', 'Repeats_X_+.txt', 'Repeats_Y_+.txt']

# List of files with repeats found in antisense strand
neg_files = ['Repeats_1_-.txt', 'Repeats_2_-.txt', 'Repeats_3_-.txt',
             'Repeats_4_-.txt', 'Repeats_5_-.txt', 'Repeats_6_-.txt',
             'Repeats_7_-.txt', 'Repeats_8_-.txt', 'Repeats_9_-.txt',
             'Repeats_10_-.txt', 'Repeats_11_-.txt', 'Repeats_12_-.txt',
             'Repeats_13_-.txt', 'Repeats_14_-.txt', 'Repeats_15_-.txt',
